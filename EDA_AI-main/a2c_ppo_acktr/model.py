...
"""Guangxi"""
def build_graph(n_in_build_graph):
...
class Policy(nn.Module):
    """Guangxi"""
    def __init__(self, obs_shape, action_space, n_in_build_graph_Policy, 
        ...
        """Guangxi"""
        self.base = base(obs_shape[0], n_in_build_graph = n_in_build_graph_Policy,
                         **base_kwargs)
        ...
        """Guangxi"""
        #self.num = n_in_evaluate_actions
    ...
    def evaluate_actions(self, inputs, rnn_hxs, masks, action, features):
        ...
        #n = self.num
        #print("GuangxiFan")
        """Any number to call the base.forward()"""
        n = 5201314
...
class NNBase(nn.Module):
    """Guangxi"""
    def __init__(self, recurrent, recurrent_input_size, hidden_size, n_in_build_graph):
        super(NNBase, self).__init__()

        self._hidden_size = hidden_size
        self._recurrent = recurrent
        #self.n_in_build_graph = n_in_build_graph
...
class CNNBase(NNBase):
    """Guangxi"""
    def __init__(self, num_inputs, n_in_build_graph, recurrent=False, hidden_size=512):
        super(CNNBase, self).__init__(recurrent, hidden_size, hidden_size, n_in_build_graph)
